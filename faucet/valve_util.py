...
DEFAULTS = {
    ...
    'FAUCET_LOG': _PREFIX + '/var/log/faucet/faucet.log:' + _PREFIX + '/var/log/ryu/faucet/faucet.log',
...
def get_setting(name):
    ...
    if isinstance(result, str) and isinstance(default_value, str) and not isinstance(default_value, bool):
